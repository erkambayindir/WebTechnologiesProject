...
<body>
	<div id="frm">
		<form action="processLogin.php" method="POST">
			...
			<br><br>
			<?php 
			$reasons = array("username" => "Hatalı kullanıcı adı veya şifre!", "blank" => "Bir yada daha fazla alanı boş bıraktınız.");
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-2 ">
                       <ul class="social-network social-circle">
                           <li><a href="https://github.com/erkambayindir/WebTechnologiesProject" target="_blank" class="icoGithub" title="Github">
                           <i class="fa fa-facebook"></i></a></li>
                           <li><a href="https://www.linkedin.com/in/erkam-bayindir-25a70635/" target="_blank" class="icoLinkedin" title="Linkedin">
